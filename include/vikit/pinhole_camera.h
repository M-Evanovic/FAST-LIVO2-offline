...
public:
  ...
  PinholeCamera(double width, double height, double scale, double fx, double fy,
                ...
                double d5 = 0.0, double d6 = 0.0, double d7 = 0.0,
                double d8 = 0.0, double d9 = 0.0, double d10 = 0.0,
                double d11 = 0.0, double d12 = 0.0, double d13 = 0.0);
